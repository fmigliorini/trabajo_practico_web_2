...
$datos = Vehiculo_model::getReporteKilometrosRecorridos();
...
<body>
    ...
    <h2><strong>Reporte de los kilometros recorridos</strong></h2><br>';
	...
	foreach ($datos as $key => $dato) : 
		...
		<p><strong>Kilometros recorridos:</strong> '.$dato->KilometrosRecorridos.' Km</p><br>';
...
$dompdf->render();
$dompdf->stream("reporte_VehiculosCostoMantenimiento.pdf");
