...
$datos = Vehiculo_model::getReporteCostoMantenimiento();
...
<body>
    ...
    <h2><strong>Reporte de los costos de mantenimiento</strong></h2><br>';
	...
	foreach ($datos as $key => $dato) : 
		...
		<p><strong>Costo mantenimiento:</strong> $ '.$dato->CostoMantenimiento.'</p><br>';
